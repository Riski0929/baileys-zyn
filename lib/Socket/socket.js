...
const makeSocket = (config) => {
    ...
    // Kalau ada customCode, pakai itu. Kalau tidak, pakai random
    authState.creds.pairingCode = customCode?.toUpperCase?.() || (0, Utils_1.bytesToCrockford)((0, crypto_1.randomBytes)(5))
